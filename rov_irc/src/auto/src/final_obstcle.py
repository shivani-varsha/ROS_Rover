...
min_obstacle_height = 15  # Minimum height difference to consider as an obstacle in mm
obs_threshold = 10
...
# Identify the closest obstacle
        ...
        for i in range(1, num_features + 1):
            ...
            if slices:
                ...
                if mean_depth < min_depth and region_size > min_size_threshold:
                    min_depth = mean_depth
                    closest_obstacle_slice = sl
        ...
        axs[3].clear()
        axs[3].imshow(obstacle_mask, cmap='gray')
        axs[3].set_title("Binary Obstacle Map")
        axs[3].axis('off')
